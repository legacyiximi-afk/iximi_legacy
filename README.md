> **Nota:** Este es el README principal. También disponibles en [Español](./README.es.md) e [Inglés](./README.en.md).
...
Somos un proyecto open-source sin fines de lucro. Si crees en nuestra misión y quieres apoyar la preservación del patrimonio cultural, considera convertirte en uno de nuestros financiadores.
